...
namespace Overcharged
{
    ...
    /// </summary>
    public class IntermittentLightningSprayer
    {
        ...
        public static ThingDef Mote_MagicPuff = ThingDef.Named("Mote_LightningZap");

        /// <summary>
        /// Initializes a new instance of the <see cref="IntermittentMagicSprayer"/> class.
        /// </summary>
        /// <param name="parent">The parent.</param>
        public IntermittentLightningSprayer(Thing parent)
        {
            this.parent = parent;
        }
        ...
        public void SteamSprayerTick()
        {
            if (sprayTicksLeft > 0)
            {
                ...
                if (Rand.Value < SprayThickness)
                    IntermittentLightningSprayer.ThrowMagicPuffUp(parent.TrueCenter(), parent.Map);
